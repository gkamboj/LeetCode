...
'''
Approach:
The addition of two integers can be thought of as adding them bit by bit, and can be subdivided into two operations:
...
To find carry: carry can be 1 or 0: 1 if at least two out of a_bit, b_bit, and previous carry are 1.
