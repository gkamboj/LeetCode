...
'''
Another approach: Without using dictionary, update the given original list such that for every node, insert its copy at next position. Fetch the new list from original list in next traversal. 
Refer https://leetcode.com/problems/copy-list-with-random-pointer/discuss/43491/A-solution-with-constant-space-complexity-O(1)-and-linear-time-complexity-O(N) for detail.
'''
