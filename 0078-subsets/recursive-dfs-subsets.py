...
# Reference-1: https://leetcode.com/problems/subsets/discuss/27301/Python-easy-to-understand-solutions-(DFS-recursively-Bit-Manipulation-Iteratively)
# Reference-2: https://leetcode.com/problems/subsets-ii/discuss/30305/Simple-python-solution-(DFS)
...
# Note: This approach returns solution is sorted as well as lexicographic order if initial input passed to recursive method is sorted.
