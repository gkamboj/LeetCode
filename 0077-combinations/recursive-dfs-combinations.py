...
# Note: Observe the if condition at line-12: This is to avoid for loop recursive calls for steps when combination of k is not possible, thereby improving time further.
